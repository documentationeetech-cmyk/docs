...
2. When you select a template you will be asked to add header media which you can import from your system.
   ...
   ![41 Whatsapp Broadcast Setup  Eetech Resource Cent 1 Pn](/images/how-botpenguin-works/whatsapp-broadcast-setup/41.whatsapp_broadcast_setup__Eetech_resource_cent-1.png)
