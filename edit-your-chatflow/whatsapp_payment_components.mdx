...
- Select the flow in which you want to include the Payment component into.
  ...
  ![20 Whatsapp Payment Eetech Botpenguin Resource C 2 Pn](/images/how-botpenguin-works/whatsapp-payment-comp/20.whatsapp_payment_Eetech__botpenguin_resource_c-2.png)
