---
title: "Integrate  Eetech with Google Analytics"
description: "This page contains step by step information on how you can integrate the Google Analytics with the  Eetech."
---

#### **Integration of Google Analytics with  Eetech**

Google Analytics is a powerful tool to measure and analyze user interactions, such as the number of clicks and views, on your chatbot. Integrating Google Analytics with your  Eetech chatbot enables you to track these metrics and optimize performance.

Follow these steps to integrate Google Analytics with  Eetech:

**Step 1: Log in to  Eetech**

1. Navigate to your [ Eetech account](https://www. Eetech.com/).
...
To connect Google Analytics to your  Eetech account, you need the Measurement ID from your Google Analytics account. Follow these steps to get it:
...
**Step 4: Connect Google Analytics to  Eetech**

1. Go back to the  Eetech integration page where you clicked **Connect** for Google Analytics.
