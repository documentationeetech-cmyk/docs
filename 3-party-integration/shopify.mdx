...
### **Steps of Integration with  Eetech:**
 ...
 3. \
    If a pop-up screen appears, go to the bottom and click on "**Shopify App Store"**. Search for "** Eetech**" and click on "**Install**".
 ...
 5. \
    Once the installation process is complete, the page will automatically redirect you to  Eetech, while a screen such as this appears.
 6. \
    You will be redirected to  Eetech. Login to your account.
 7. \
...
11. \
    You will be redirected to Shopify admin panel, which will redirect back to the  Eetech page, and this will confirm your integration.
