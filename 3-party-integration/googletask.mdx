...
c. After you click allow, the connection between  Eetech and Google Task is

established,and you will be redirected back to  Eetech.

### **Step 3 of 4: Set up Mapping Parameters**

a. Now, as connection of the  Eetech and Google Task is established, you need

to map **parameters (fields) of Google Task** to the user response of the  Eetech question.
