---
title: "Integrate  Eetech with SimplyBook"
description: "This page contains the stepwise tutorial for the integration of SimplyBook with  Eetech."
---

**\
Access Your  Eetech Account**

- Log in to your  Eetech account and select the bot you wish to integrate with SimplyBook.

**\
Navigate to Third-Party App Integrations**

- Go to the "Third-Party App Integrations" section in your  Eetech account.
