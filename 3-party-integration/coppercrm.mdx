...
- **Personalized Customer Interactions:** Use  Eetech to deliver tailored messages based on customer data stored in Copper CRM.
...
### **Integrate  Eetech with Copper:-**

### **Step 1 of 4: Login to  Eetech Account and Select Application to Integrate**

1. Login to your  Eetech account, and select the Bot you want to integrate with Copper.
...
2. **\
   ...
   - \
     Copy your API Key and paste It on  Eetech.
3. **\
   Email Address:-**
...
Once you have established a connection between ** Eetech** and Copper and complete the mapping, you are ready to go for your first test lead. You can test your integration setup by creating a dummy lead on the bot. This lead should appear in your  Eetech dashboard and the Copper you have integrated.
