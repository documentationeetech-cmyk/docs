...
### **How to use  Eetech as Trigger**
 ...
 8. \
    You can now click on the "\+" icon in canvas and search for  Eetech in the search bar.
...
### **How to use Action in  Eetech**
 ...
 8. \
    Set up connection by providing the **API key and BotID **from  Eetech as explained above.
