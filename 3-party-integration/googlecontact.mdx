...
### **Integrate  Eetech with Google Contacts**

 1. **Login to  Eetech:**
    - Start by logging into your  Eetech account.
 2. **\
    Navigate to the Bot:**
 ...
 6. **Login to Google Account:**
    - You will be prompted to log into your Google account. Ensure you use the Google account you want to link with  Eetech.
 7. **\
    Grant Permissions:**
    - Follow the on-screen instructions to grant  Eetech the necessary permissions to access your Google Contacts.
 8. **Map the Questions:**
...
11. **Check the Contact Section:**
    - In the "Contact" section of your  Eetech dashboard, you will see the demo leads created by the integration.
