---
title: "Integrate  Eetech with Razorpay"
description: "This page contains al the necessary information on how you can interate the Razorpay with Botepenguin"
---

### **Prerequisites**

To successfully integrate Razorpay with  Eetech, you will need:

- A ** Eetech** account.
- A **Razorpay** account.
- A **WhatsApp bot**

This integration enables your WhatsApp bot created on  Eetech to collect payments via Razorpay.

#### **Step 1: Login to  Eetech and Select WhatsApp Bot**

1. Go to [ Eetech](https://www. Eetech.com/) and log into your account.
...
To connect Razorpay with  Eetech, you need the **Client ID** and **Client Secret** from your Razorpay account.
...
#### **Step 4: Connect Razorpay to  Eetech**
...
4. Go back to  Eetech and copy the **Webhook URL** from the integration settings.
...
1. Navigate back to your  Eetech bot editor.
2. \
...
Your  Eetech WhatsApp bot is now successfully integrated with Razorpay. You can collect payments seamlessly and track payment events through the configured webhooks. This integration ensures a smooth payment experience for your users directly through WhatsApp.   