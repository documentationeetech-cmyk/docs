...
Here is the process to create the WhatsApp Bot using the  Eetech's Automated onboarding.

This document will guide you through the step-by-step process of creating the  Eetech WhatsApp Bot using the WhatsApp Business Cloud API. Following these instructions, you can set up your WhatsApp Bot and integrate it with the  Eetech platform.

## **Step 1: Check for Pre-requisites**

Before you begin, ensure you have the necessary prerequisites in place, such as access to the  Eetech platform, WhatsApp number, etc.
...
#### **2.1 Register your bot on  Eetech**

1. Login to your  Eetech Portal and Click the "Create Bot" button on the top right.

   ![7 Whatsapp Chatbot  Eetech Resource Centre 1 Pn](/images/how-botpenguin-works/create-newchatbot/7.whatsapp_chatbot__Eetech_resource_centre-11.png)
2. Select "WhatsApp" as the platform on the next page.

   Choose Platform

   ![7 Whatsapp Chatbot  Eetech Resource Centre 12 Pn](/images/how-botpenguin-works/create-newchatbot/7.whatsapp_chatbot__Eetech_resource_centre-12.png)
3. Provide the required details and follow the bot creation process.

   ![7 Whatsapp Chatbot  Eetech Resource Centre 5 Pn](/images/how-botpenguin-works/create-newchatbot/7.whatsapp_chatbot__Eetech_resource_centre-5.png)
4. Scan the QR Code and initiate a WhatsApp message to create the demo bot 1st. Scan or Send Confirmation message

   ![7 Whatsapp Chatbot  Eetech Resource Centre 6 Pn](/images/how-botpenguin-works/create-newchatbot/7.whatsapp_chatbot__Eetech_resource_centre-6.png)
5. Upon successful verification, Click "Connect to your WhatsApp number" to start the Automated onboarding.

   ![7 Whatsapp Chatbot  Eetech Resource Centre 7 Pn](/images/how-botpenguin-works/create-newchatbot/7.whatsapp_chatbot__Eetech_resource_centre-7.png)

#### **2.2 Complete Meta Automated onboarding**

1. Select all the pre-requisite and click "Proceed"

   ![7 Whatsapp Chatbot Eetech Resource Centre 8 Pn](/images/how-botpenguin-works/create-newchatbot/7.whatsapp_chatbot__Eetech_resource_centre-8.png)
2. Choose Automated or Manual onboarding. In this document, We will talking about Automated onboard.

   ![7 Whatsapp Chatbot  Eetech Resource Centre 9 Pn](/images/how-botpenguin-works/create-newchatbot/7.whatsapp_chatbot__Eetech_resource_centre-9.png)
3. It will open up a new pop-up window where you have to complete the Meta onboarding.

   ![7 Whatsapp Chatbot  Eetech Resource Centre 10 Pn](/images/how-botpenguin-works/create-newchatbot/7.whatsapp_chatbot__Eetech_resource_centre-10.png)
...
![7 Whatsapp Chatbot  Eetech Resource Centre 1 Pn](/images/how-botpenguin-works/create-newchatbot/7.whatsapp_chatbot__Eetech_resource_centre-1.png)
...
![7 Whatsapp Chatbot  Eetech Resource Centre 2 Pn](/images/how-botpenguin-works/create-newchatbot/7.whatsapp_chatbot__Eetech_resource_centre-2.png)
...
![7 Whatsapp Chatbot  Eetech Resource Centre 3 Pn](/images/how-botpenguin-works/create-newchatbot/7.whatsapp_chatbot__Eetech_resource_centre-3.png)
...
![7 Whatsapp Chatbot  Eetech Resource Centre 4 Pn](/images/how-botpenguin-works/create-newchatbot/7.whatsapp_chatbot__Eetech_resource_centre-4.png)
...
Congratulations\! You have successfully created the  Eetech WhatsApp Bot using the WhatsApp Business Cloud API and integrated it with the  Eetech platform. Your WhatsApp Bot is now ready to interact with users and provide automated responses.

<Info>
  Please note that specific steps and requirements may vary based on updates and changes in the  Eetech and WhatsApp Business Cloud API platforms. If you encounter any difficulties during the process or have further questions, please refer to the official documentation of  Eetech and WhatsApp Business Cloud API, or contact their support teams for assistance.
</Info>