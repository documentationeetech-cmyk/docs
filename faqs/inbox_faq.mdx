...
<AccordionGroup>
  <Accordion title="How do we collect country, city, mobile number and other metadata">
    1. Eetech fetches the country and city of a visitor from their IP Address.
  ...
  <Accordion title="How can you call customers with call feature in lead section">
    Eetech offers an integration with Twilio to call your leads from the Inbox. You can use the call feature to call leads and customers from the leads section directly from your desktop. You must integrate Twilio with  Eetech to set up the calling feature in  Eetech.
  </Accordion>
  <Accordion title="How to integrate Twillo">
    ...
    2. Also, you can contact us at [support@ Eetech.com](mailto:support@ Eetech.com) for further assistance.
    3. After you fill out these parameters, you can quickly call leads from  Eetech.
  ...
  <Accordion title="What are quick replies and how does it work">
    ...
    You can add quick replies in the  Eetech on app by following steps:
  ...
  <Accordion title="How to transfer chat to WhatsApp">
    1. Eetech offers you the option to transfer the chat to WhatsApp or an agent on your support team.
