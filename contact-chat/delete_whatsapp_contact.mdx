...
This API endpoint allows you to update the status of users in your  Eetech application.

**Endpoint URL:** `https://api.v7. Eetech.com/inbox/users/status-update`
...
```
curl 'https://api.v7. Eetech.com/inbox/users/status-update' \
  -X 'PUT' \
